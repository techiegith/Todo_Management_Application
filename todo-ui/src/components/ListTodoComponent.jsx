...
const ListTodoComponent = () => {
    // We need to create a state variable and awe need to store this  dummyData in a state variable.
    // we use useState hook allows us to useState variable in a functional LastTodoComponent.
    // setTodos is the function that will update the state.and todos is the name of state variable.and dummyData is the intial value 
